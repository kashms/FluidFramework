...
export function App(props: { tree: ISharedTree }): JSX.Element {
    ...
    return (
        <div id="main">
            <div id="piles">
                {pilesArray}
                <button id="addPile" onClick={addPile}>
                    Add Pile
                </button>
            </div>
        </div>
...
function Pile(props: { pile: Pile }): JSX.Element {
    return (
        <div className="pile">
            <input
                className="pileTitle"
...
function Notes(props: { pile: Pile }): JSX.Element {
...
function Note(props: { note: Note }): JSX.Element {
    return (
        <div className="note">
            <textarea
...
function Button(props: { pile: Pile }): JSX.Element {
    function addNote() {
        const note = {
            text: 'New Note!',
            author: '',
